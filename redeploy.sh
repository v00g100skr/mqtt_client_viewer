...
docker run --name home_assistant_viewer --restart unless-stopped -d -p "$PORT":"$PORT"  --env PORT="$PORT" --env HA_TOKEN="$HA_TOKEN" --env HA_HOST="$HA_HOST" home_assistant_viewer
